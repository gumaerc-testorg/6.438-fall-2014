...
- Jordan, Michael Irwin. *Introduction to Probabilistic Graphical Models*. ({{% resource_link "ba03fb5f-2a36-480e-8247-36591202ed56" "Lecture notes" %}})
- {{% resource_link "857b3f12-6370-4d06-9a0e-41610d090a9e" "![Buy at MIT Press](/images/mp_logo.gif)" %}} Koller, Daphne, and Nir Friedman. *Probabilistic Graphical Models: Principles and Techniques*. MIT Press, 2009. ISBN: 9780262013192. \[Preview with {{% resource_link "18ef4c80-b782-49bb-8fb3-1340e6b9abf8" "Google Books" %}}\]
- MacKay, David J. C. *Information Theory, Inference, and Learning Algorithms*. Cambridge University Press, 2003. ISBN: 9780521642989. (Also available on-line at {{% resource_link "755c6289-d5c7-4dae-a542-d0c37a1b77fe" "http://www.inference.phy.cam.ac.uk/mackay/itila/book.html" %}})
...
- Bishop, Christopher M. *Pattern Recognition and Machine Learning*. Springer, 2006.
- Bremaud, Pierre. *Markov Chains: Gibbs Fields, Monte Carlo Simulation, and Queues*. Springer, 2008. \[Preview with {{% resource_link "f99f7f25-61a0-4811-8764-43ff37d3294e" "Google Books" %}}\]
- Cowell, Robert, Philip Dawid, et al. *Probabilistic Networks and Expert Systems: Exact Computational Methods for Bayesian Networks*. Springer, 1999. ISBN: 9780387718231. \[Preview with {{% resource_link "ba994664-ca85-47c7-b920-82c6e7f03bb1" "Google Books" %}}\]
...
- Jensen, Finn V, and Thomas D. Nielsen. *Bayesian Networks and Decision Graphs*. Springer, 2007. ISBN: 9780387682815 \[Preview with {{% resource_link "50afdf9e-bd5b-4aa2-919d-30ab9c9ae0a9" "Google Books" %}}\]
...
- Arulampalam, M. Sanjeev, Simon Maskell, et al. "{{% resource_link "9e2a9954-a5ad-44ca-8c78-1abdc460111d" "A Tutorial on Particle Filters for Online Nonlinear / Non-Gaussian Bayesian Tracking" %}}." *IEEE Transaction on Signal Processing* 50, no. 2 (2002): 174–88.
- G. David Forney, Jr. "{{% resource_link "c17b5f63-6957-44e2-976e-a248f663a4c3" "The Viterbi Algorithm" %}}." *Proceedings of the IEEE* 61, no. 3 (1973): 268–78.
- Frey, Brendan J., and Nebojsa Jojic. "{{% resource_link "31ac40e3-1beb-4876-84e7-a2a39fc39618" "A Comparison of Algorithms for Inference and Learning in Probabilistic Graphical Models" %}}." *IEEE Transaction on Pattern Analysis and Machine Intelligence* 27, no. 9 (2005): 1392–416.
- Jaakkola, Tommi. "Tutorial on Variational Approximation Methods." In *Advanced Mean Field Methods: Theory and Practice*. Edited by M. Opper and D. Saad. A Bradford Book, 2001, pp. 129–60. ISBN: 9780262150545. \[Preview with {{% resource_link "91216667-544e-4dc9-8f70-28a9802ae234" "Google Books" %}}\]
- Jordan, Michael Irwin. "{{% resource_link "3c08e452-b4a0-4ee7-a35c-d09243cdc84b" "Graphical Models" %}}." *Statistical Science* 19, no. 1 (2004): 140–55.
- Kalman, R. E. "{{% resource_link "2927bb8f-ffb1-44e5-9ae5-eb88da4b6946" "A New Approach to Linear Filtering and Prediction Problems" %}}." *Transaction on The American Society of Mechanical Engineering Journal of Basic Engineering*, no. 82 series D (1960): 35–45.
- Kschischang, Frank, Brendan Frey, et al. "{{% resource_link "d66a9ec6-04ec-4dfa-8b1c-93c9f34b7fb3" "Factor Graphs and the Sum Product Algorithm" %}}." *IEEE Transaction on Information Theory* 47, no. 2 (2001): 498–519.
- Loeliger, Hans-Andrea. "{{% resource_link "d745187a-49db-47fe-89f9-f96a14a9cda0" "An Introduction to Factor Graphs" %}}." *IEEE Signal Processing Magazine* 21, no. 1 (2004): 28–41.
- Loeliger, Hans-Andrea, Justin Dauwels, et al. "{{% resource_link "2857b374-4564-4fdf-9180-069883c24565" "The Factor Graph Approach to Model-Based Signal Processing" %}}." *Proceedings of the IEEE* 95, no. 6 (2007): 1295–322.
- Rabiner, Lawrence R. "{{% resource_link "b5706de3-bff3-4f24-96a1-2021e385d393" "A Tutorial on Hidden Markov Models and Selected Applications in Speech Recognition" %}}." *Proceedings of the IEEE* 77, no. 2 (1989): 257–86.
- Wainwright, Martin, and Michael I. Jordan. "Graphical Models, Exponential Families, and Variational Inference." Technical Report 649, Department of Statistics, University of California, September 21, 2003.   
    Updated version: Wainwright, M. J., and M. I. Jordan. "{{% resource_link "ddecef39-3eda-4c4a-8afd-021373adf8ec" "Graphical Models, Exponential Families, and Variational Inference" %}}." *Foundations and Trends in Machine Learning* 1, no. 1–2 (2008): 1–305.
- Yedidia, Jonathan, William T. Freeman, et al. "Understanding Belief Propagation and its Generalizations." In *Exploring Artificial Intelligence in the New Millennium*. Morgan Kaufmann, 2002. ISBN: 9781558608115. \[Preview with {{% resource_link "fbb1646c-fc0c-40c9-8be7-9c5c78c8c41b" "Google Books" %}}\]
- Yedidia, Jonathan, William T. Freeman, et al. "{{% resource_link "5e8104b5-ba45-46bb-a9cd-0647c76edee1" "Constructing Free-Energy Approximations and Generalized Belief Propagation Algorithms" %}}." *IEEE Transaction on Informtion Theory* 51, no. 7 (2005): 2282–312.